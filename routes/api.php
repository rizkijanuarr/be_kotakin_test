...
Route::prefix('/v1/admin')->group(function () {
    ...
    Route::middleware(['auth:api_admin', \App\Http\Middleware\AuditAccess::class])->group(function () {
        ...
        Route::get('dashboard', [DashboardControllerV1::class, 'dashboard']);
...
Route::prefix('/v1/user')->group(function () {
    Route::post('login', [UserAuthControllerV1::class, 'login']);
    Route::post('register', [UserAuthControllerV1::class, 'register']);

    Route::middleware(['auth:api_user', \App\Http\Middleware\AuditAccess::class])->group(function () {
        Route::post('refresh-token', [UserAuthControllerV1::class, 'refreshToken']);
        Route::post('logout', [UserAuthControllerV1::class, 'logout']);
        Route::get('me', [UserAuthControllerV1::class, 'me']);
        Route::get('dashboard', [UserDashboardControllerV1::class, 'dashboard']);
